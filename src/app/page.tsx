...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-[#fcfcfd] text-slate-900 selection:bg-blue-100 selection:text-blue-900 relative overflow-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/40 backdrop-blur-2xl border-b border-slate-200/40">
        <div className="max-w-7xl mx-auto px-10 h-20 flex items-center justify-between">
          ...
          <Link 
            href="/dashboard"
            className="group relative flex items-center gap-2.5 px-6 py-3 rounded-full bg-slate-900 text-white font-black text-xs uppercase tracking-widest hover:bg-blue-600 transition-all hover:-translate-y-0.5 active:scale-95"
          >
      ...
      <main className="flex-grow relative z-10 pt-44 pb-32">
        <section className="max-w-6xl mx-auto px-10 text-center relative">
          <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/60 backdrop-blur-xl border border-slate-200/50 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 mb-10 animate-in fade-in zoom-in-95 duration-700">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-in slide-in-from-bottom-12 duration-1000 delay-400">
            <Link 
              href="/dashboard"
              className="w-full sm:w-auto px-12 py-6 bg-slate-900 text-white font-black text-sm uppercase tracking-widest rounded-[2rem] hover:bg-blue-600 transition-all hover:-translate-y-1 active:scale-95 flex items-center gap-3"
            >
        ...
        <section className="max-w-7xl mx-auto px-10 py-44 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="group p-10 bg-white/60 backdrop-blur-xl rounded-[3.5rem] border border-slate-100 border-slate-200 transition-all duration-700 hover:-translate-y-1 relative overflow-hidden flex flex-col min-h-[400px]">
              ...
              <div className="w-16 h-16 bg-blue-600 text-white rounded-[1.5rem] flex items-center justify-center mb-10 group-hover:rotate-[15deg] transition-transform duration-500">
                <Brain size={28} />
              </div>
        ...
        <section className="max-w-6xl mx-auto px-10 py-32 relative text-center">
           <div className="bg-slate-900 rounded-[4rem] p-24 relative overflow-hidden border border-slate-800">
              ...
              <div className="relative z-10 flex flex-col items-center gap-10">
                 ...
                 <Link 
                   href="/dashboard"
                   className="group relative inline-flex items-center gap-4 px-12 py-7 bg-white text-slate-900 font-black text-xl rounded-[2.5rem] hover:bg-blue-600 hover:text-white transition-all duration-500 active:scale-95"
                 >
